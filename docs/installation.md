...
<TabItem value="hybrid" label="Hybrid Installation (Recommended)">
    ...
    **Scenarios**
    ...
    If you want to define your own scenarios, clone and install from source:
    ...
    Editable mode (`-e`) allows you to modify or add scenarios without reinstalling.

    If you do not plan to customize scenarios, a non-editable install is sufficient:
...
<TabItem value="docker" label="Docker Installation">
    ...
    **Core Dockers**
    ...
    docker run -it \
        ...
        -v ./magma-scenarios:/home/magma-scenarios \
        ...
        bash -c "
            ...
            pip install -e /home/magma-scenarios && \
