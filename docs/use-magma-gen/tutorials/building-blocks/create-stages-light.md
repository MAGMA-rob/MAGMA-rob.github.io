...
If you need text-only stages, log verification, additive stages, or deeper stage internals, continue with [Create Stages (Detailed)](../../deep-dive/create-stages.md).

:::info
This page complements the main [Create your custom scenario in 5 minutes](../create-scenarios.md) tutorial.
Use it as a drill-down on the stage step, not as a separate authoring flow.
:::
...
:::danger
Be aware that this exemple is a very simplified illustration. We do not recommend to define specific stage like this. Check [how to define reusable stage](../make-reusable-stages.md) to see more information. 
:::
...
Use the [detailed page](../../deep-dive/create-stages.md) for more information, or specific tutorials when you need:

- text-only stages with `verification_prompt`: [tuto](../constraint-cycle.md)
- `verif_log_completion(...)`: [tuto](../log-verification.md)
- additive stages: [tuto](../modify-attributes.md)
