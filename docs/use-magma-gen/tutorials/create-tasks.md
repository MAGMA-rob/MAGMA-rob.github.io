...
description: Simple guide to defining and registering MAGMA task presets with BaseTask.
---
...
For task definitions, request systems, task state builders, or constraint-generation pipelines, check [**Task Definitions**](create-tasks-definition.md)
