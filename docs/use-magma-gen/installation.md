...
You must have completed the **core installation procedure**. You have the choice between [**hybrid**](../installation/hybrid-install.md) (recommended), [conda](../installation/conda-install.md) or [docker](../installation/docker-install.md).
...
Currently we mostly supports Ollama server. But you can create your own clients if needed. See [**Create your own backend**](../customization/create-backends.md)
