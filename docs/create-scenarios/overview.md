...
That first result is enough to understand how the pieces fit together. You do not need requests, skills, or perfect traces to reach it.
...
The first group takes you from a package to a tested task. **Build Your Components** explains how to implement its pieces; **Design Interactions** explains how to combine them into user-facing behavior. The remaining groups cover procedural variations and optional execution, trace, and replay capabilities.
